...
# lsita
mi_lista = [1, 3.1416, "juan", mi_tupla]
print("el primer elento de mi lista:", mi_lista[0])
print("el cuarto elento de mi lista:", mi_lista[3])
print("el tercer elento de mi lista:", mi_lista[2])
